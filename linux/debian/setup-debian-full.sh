...
# Optimized for Debian and Debian-based distributions
...
install_utilities() {
    ...
    # Install btop if available (may need to build from source on older Debian)
    sudo apt-get install -y btop || print_warning "btop not available in repositories"
}
...
install_additional_tools() {
    ...
    sudo apt-get install -y bat || print_warning "bat not available"
    sudo apt-get install -y fd-find || print_warning "fd-find not available"
    sudo apt-get install -y ripgrep || print_warning "ripgrep not available"
    sudo apt-get install -y fzf || print_warning "fzf not available"

    # eza (modern ls replacement) - may need to install from GitHub releases
    ...
    sudo apt-get install -y tldr || print_warning "tldr not available"
}
...
install_gpu_drivers() {
    ...
    if lspci | grep -i nvidia > /dev/null; then
        ...
        print_warning "To install NVIDIA drivers, run: sudo apt-get install nvidia-driver"
    fi
...
main() {
    print_info "Starting Debian Linux Setup Script"
    print_info "================================="
    ...
    print_info "\n================================="
    print_info "Debian Linux setup complete!"
